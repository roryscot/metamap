...
export const METAMAP_VIABILITY_POLICY_VERSION = "1.0.0" as const;
export const METAMAP_GENERATION_VERSION = "1.0.0" as const;
...
export type ActivationResult =
  | {
      ...
      compilation: Extract<CompilationResult, { status: "viable" }>;
    }
  | {
      activated: false;
      current?: ViableGeneration;
      compilation: Extract<CompilationResult, { status: "rejected" }>;
    };
